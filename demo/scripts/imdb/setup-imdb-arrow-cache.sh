...
# IMDB Arrow Cache Setup Script
# This script sets up the Arrow Cache system configured for the IMDB dataset
...
MANIFESTS_DIR="$(dirname "$(dirname "$SCRIPT_DIR")")/manifests/arrow-cache-imdb"
...
setup_aws_credentials() {
    ...
    if [ -n "$iam_role_arn" ]; then
        ...
        TEMP_OVERLAY_DIR="/tmp/arrow-cache-imdb-irsa-overlay"
...
# Use the base arrow-cache-imdb manifests and add IRSA service account
resources:
- base
